  ...
  return (
    <AdminLayout>
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600">Manage office networks & IP security for attendance</p>
      </div>
      ...
      {activeTab === 'networks' && (
        <div>
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Allowed Office Networks</h3>
          ...
          {networks.length === 0 ? (
            <Card className="p-8 text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">No Networks Configured</h4>
          ...
          <Card className="mt-6 p-4 bg-blue-50 border border-blue-200">
            <h4 className="font-semibold text-blue-900 mb-2">ℹ️ How IP Restriction Works</h4>
